    ...
    return (
        <div id='work' className='mywork'>
                ...
                {mywork_data.map((work, index) => (
                    <div className="mywork-item" key={index}>
                        ...
                        <div className="mywork-info">
                            <span className="project-no">Project {work.w_no}</span>
            ...
            <div className="mywork-footer">
                <a href="https://github.com/Tech-Ninja478?tab=repositories" target="_blank" rel="noreferrer" className="mywork-main-btn">
                    <span>Show More on GitHub</span>
